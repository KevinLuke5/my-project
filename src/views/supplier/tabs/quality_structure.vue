<template>
  <div>
    <div class="tab-top-btn">
      <j-button v-auth="'quality_structure_update'" @click="addLine">
        新增
      </j-button>
      <j-button v-auth="'quality_structure_update'" @click="handleEdit">
        编辑
      </j-button>
      <j-button v-auth="'quality_structure_delete'" @click="handleDel">
        删除
      </j-button>
      <j-button @click="handleTree">
        生成组织图
      </j-button>
      <j-button v-auth="'quality_structure_save'" type="primary" @click="handleSubmit">
        保存
      </j-button>
    </div>
...
const urlType = 'quality_structure'
