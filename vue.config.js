...
module.exports = {
  ...
  chainWebpack (config) {
    ...
    //     url: 'https://sentry-test.joyoung.com/',
    //     authToken: '26e48073aa044759bab861143802e63501a316b14f7a49d19339f00c6b6781e7',
    //     org: 'jyfe',
    //     project: 'srm-pc',
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      config.plugin('extract-css').tap((args) => [{
        ...
        chunkFilename: `static/css/[name].[chunkhash].${Timestamp}.css`
      }])
    }
  }
}
